...
if frequencia1 > 0 or frequencia2 > 0:
    ...
    display(f"A palavra {palavra1} foi encontrada {frequencia1} vezes e a palavra {palavra2} foi encontrada {frequencia2} vezes na página.")
...
# Abre o arquivo em modo de Leitura
    ...
    display(f"A palavra {palavra1} e/ou a palavra {palavra2} não foram encontradas na página.")
